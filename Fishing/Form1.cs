...
namespace Fishing
{
    public partial class FormGame : Form
    {
        ...
        private const int IwashiSpeed = 25; //イワシのスピード
        private const int UtsuboSpeed = 20; //ウツボのスピード
        private const int AnkouSpeed = 50;   //アンコウのスピード
        private const int DayTime = 150;    //昼間の時間(10秒)
